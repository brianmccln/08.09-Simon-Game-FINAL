...
// 5. Declare an array of the 4 colors, these are for playing sounds that 
// go with the colors; they need to go in the order they appear in the HTML
const colorSounds = ['green.mp3', 'red.mp3', 'yellow.mp3', 'blue.mp3'];
    ...
    // e.addEventListener('click', () => {
        ...
        // if() {
            ...
            // if() {
                ...
                // `Keep Going! Correct Count: ${clicks+1}`;
